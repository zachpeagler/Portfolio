   ...
   nav_panel("Fluorescence",
     tabsetPanel(
       tabPanel("Distributions",
        card(markdown("*Please note that the distributions will not change with 
                      sidebar inputs due to how computationally expensive they are. 
                      Except the color palette, because it's cheap as dirt.*")),
  ...
  nav_panel("Fruit",
    tabsetPanel(
      tabPanel("Distributions",
        card(markdown("*Please note that the distributions will not change with 
                      sidebar inputs due to how computationally expensive they are. 
                      Except the color palette, because it's (relatively) cheap.*")),
