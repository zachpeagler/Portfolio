...
require(tidyverse); require(lme4); require(showtext); require(scico); require(pwr); require(car); require(ggpubr); require(rstatix); require(ggridges); require(MASS)
...
### 3.1.2 Stomatal Conductance Analysis
